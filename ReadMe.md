...
* BookStorageImpl 108 VALUE
* Логика перенесена с проекта на H2, а у меня PosgreSQL - есть разница в синтаксисе, нужно переписать
* Да, файл дата я тоже на коленке переписала, не забудь, что теперь кака может быть и там закопана
